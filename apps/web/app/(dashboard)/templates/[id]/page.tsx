...
import { TemplateEditLoader } from "@/components/templates/TemplateEditLoader";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1 text-sm">
          Update your creative framework and AI instructions
        </p>
      </div>
      <TemplateEditLoader templateId={params.id} />
    </div>
  );
}
